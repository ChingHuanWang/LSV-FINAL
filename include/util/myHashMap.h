...
{
public:
   HashKey(size_t in0, size_t in1): _in0(in0), _in1(in1) {}
   size_t getIn0() const { return _in0; }
   size_t getIn1() const { return _in1; }
...
public:
   ...
   { 
      size_t k0 = k.getIn0() < k.getIn1() ? k.getIn0() : k.getIn1();
      size_t k1 = k.getIn0() > k.getIn1() ? k.getIn0() : k.getIn1();
      string keyStr = to_string(k0) + to_string(k1);
      size_t ret = 0;
